...
The Comple\ **X** **G**\ roup **I**\ nteractions `(XGI) <https://github.com/xgi/xgi>`_ library provides data structures and algorithms for modeling and analyzing
complex systems with group (higher-order) interactions.

- Repository: https://github.com/xgi/xgi
...
`code of conduct
<https://github.com/xgi/xgi/blob/main/CODE_OF_CONDUCT.md>`_
and the `contributing guidelines
<https://github.com/xgi/xgi/blob/main/CONTRIBUTING.md>`_.

The best way to contribute to XGI is by submitting a bug or request a new feature by
opening a `new issue <https://github.com/xgi/xgi/issues/new>`_.

To get more actively involved, you are invited to browse the `issues page
<https://github.com/xgi/xgi/issues>`_ and choose one that you can
...
<https://github.com/xgi/xgi/blob/main/LICENSE.md>`_.
