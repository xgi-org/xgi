...
def test_constructor(edgelist5, dict5, incidence5, dataframe5):
    ...
    assert list(H_list.nodes) == list(H_dict.nodes) == list(H_mat.nodes) == list(H_df.nodes)
    assert list(H_list.edges) == list(H_dict.edges) == list(H_mat.edges) == list(H_df.edges)
    assert list(H_list.edges[0]) == list(H_dict.edges[0]) == list(H_mat.edges[0]) == list(H_df.edges[0])
